...
<link rel="stylesheet" type="text/css" href="/css/hearsay.css" /> 
  ...
  <body>
	...
	function getCategoryIDforApp(validationTemplate){
	...
	axios({
                  ...
                  //return response;
					...
					console.log("Parsed response.data " + xmlDoc.getElementsByTagName("OverallStatus")[0]);
					//loaddata(jsonObject);				
                  });
	    ...
	    axios({
		  ...
		  if(this.state.page==2){
			  let validationTemplate = {
				...
				getCategoryIDforApp(validationTemplate);
		  }
