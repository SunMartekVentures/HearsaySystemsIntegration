		  ...
		  if(this.state.page==2){
			  ...
			  axios({
                  ...
                  .then(function (response) {
					...
					console.log("Parsed response.data " + JSON.stringify(xmlDoc.getElementsByTagName("Name")[0].childNodes[0].nodeValue));
					if(JSON.stringify(xmlDoc.getElementsByTagName("Name"))!={}){
						console.log("Condition Satisfied, Parsed response.data " + JSON.stringify(xmlDoc.getElementsByTagName("Name")[0].childNodes[0].nodeValue));
					}
					else{
						console.log("Condition not satisfied");
					}
					//ExistingTemplateName = (xmlDoc.getElementsByTagName("Name")!=undefined)?(xmlDoc.getElementsByTagName("Name")[0].childNodes[0].nodeValue):undefined;
	      ...
	      ValidationStatus=false;
            ...
            if(this.state.templatename=="" && this.state.temp1text=="" && this.state.temp2text=="" && 
              ...
              ValidationStatus=false;
				...
				if(ExistingTemplateName!=""|| ExistingTemplateName != undefined){
					ValidationStatus = false;
