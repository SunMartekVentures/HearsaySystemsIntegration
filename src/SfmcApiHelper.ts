...
export default class SfmcApiHelper
{
    ...
    private createDataExtensionHelper(oauthAccessToken: string, jsonData: string) : Promise<any>    
    {
        ...
        return new Promise<any>((resolve, reject) =>
        {
		let soapData = '<?xml version="1.0" encoding="UTF-8"?><s:Envelope xmlns:s="http://www.w3.org/2003/05/soap-envelope" xmlns:a="http://schemas.xmlsoap.org/ws/2004/08/addressing" xmlns:u="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd"><s:Header><a:Action s:mustUnderstand="1">Create</a:Action><a:MessageID>urn:uuid:7e0cca04-57bd-4481-864c-6ea8039d2ea0</a:MessageID><a:ReplyTo><a:Address>http://schemas.xmlsoap.org/ws/2004/08/addressing/role/anonymous</a:Address></a:ReplyTo><a:To s:mustUnderstand="1">https://mcj6cy1x9m-t5h5tz0bfsyqj38ky.soap.marketingcloudapis.com/Service.asmx</a:To><fueloauth xmlns="http://exacttarget.com">{{oauthAccessToken}}</fueloauth></s:Header><s:Body xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema"><CreateRequest xmlns="http://exacttarget.com/wsdl/partnerAPI"><Options/><Objects xsi:type="DataExtension"><PartnerKey xsi:nil="true"/><ObjectID xsi:nil="true"/><Name>SivaDE</Name><IsSendable>false</IsSendable><Fields><Field><Name>EmailAddress</Name><FieldType>EmailAddress</FieldType><IsPrimaryKey>true</IsPrimaryKey><IsRequired>true</IsRequired></Field><Field><Name>SubscriberKey</Name><FieldType>Text</FieldType><IsRequired>false</IsRequired></Field><Field><Name>Date</Name><FieldType>Date</FieldType><DefaultValue>getdate()</DefaultValue><IsRequired>true</IsRequired></Field><Field><Name>Average_Order_Value</Name><FieldType>Decimal</FieldType><IsRequired>true</IsRequired><Precision>10</Precision><Scale>2</Scale></Field><Field><Name>Is_Proofing_Customer</Name><FieldType>Boolean</FieldType><DefaultValue>true</DefaultValue><IsRequired>true</IsRequired></Field><Field><Name>Number_of_Clusters</Name><FieldType>Number</FieldType><IsRequired>false</IsRequired></Field><Field><Name>Telephone</Name><FieldType>Phone</FieldType><IsRequired>false</IsRequired></Field><Field><Name>Locale</Name><FieldType>Locale</FieldType><IsRequired>false</IsRequired></Field></Fields><CustomerKey>SamDE01</CustomerKey></Objects></CreateRequest></s:Body></s:Envelope>';
		let headers = {
