...
export default class SfmcApiHelper
{
    ...
    private createDataExtensionHelper(oauthAccessToken: string, jsonData: string) : Promise<any>    
    {
        ...
        return new Promise<any>((resolve, reject) =>
        {
		let soapData = '<?xml version="1.0" encoding="UTF-8"?><s:Envelope xmlns:s="http://www.w3.org/2003/05/soap-envelope" xmlns:a="http://schemas.xmlsoap.org/ws/2004/08/addressing" xmlns:u="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd"><s:Header><a:Action s:mustUnderstand="1">Create</a:Action><a:To s:mustUnderstand="1">"https://mcj6cy1x9m-t5h5tz0bfsyqj38ky.soap.marketingcloudapis.com/Service.asmx"</a:To><fueloauth xmlns="http://exacttarget.com">{{oauthAccessToken}}</fueloauth></s:Header><soapenv:Body>CreateRequest xmlns="http://exacttarget.com/wsdl/partnerAPI"><Options></Options><Objects xmlns:ns1="http://exacttarget.com/wsdl/partnerAPI" xsi:type="ns1:DataExtension"><CustomerKey>DataExtensionFromAPI</CustomerKey><Name>DataExtensionFromAPI</Name><IsSendable>true</IsSendable><SendableDataExtensionField><CustomerKey>EmailAddress_Key</CustomerKey><Name>EmailAddress</Name><FieldType>EmailAddress</FieldType></SendableDataExtensionField><SendableSubscriberField><Name>Email Address</Name><Value></Value></SendableSubscriberField><Fields><Field><CustomerKey>EmailAddress_Key</CustomerKey><Name>EmailAddress</Name><FieldType>EmailAddress</FieldType></Field><Field><CustomerKey>ChannelUser_Key</CustomerKey><Name>ChannelUser</Name><FieldType>Text</FieldType></Field><Field><CustomerKey>ChannelUser_EmailAddress_Key</CustomerKey><Name>ChannelUser_EmailAddress</Name><FieldType>EmailAddress</FieldType></Field><Field><CustomerKey>Demographic_Address_Key</CustomerKey><Name>Demographic_Address</Name><FieldType>Text</FieldType></Field></Fields></Objects></CreateRequest></soapenv:Body>'
		let headers = {
