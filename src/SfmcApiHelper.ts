...
+'<CustomerKey>Org_Setup</CustomerKey>'
        	...
        	+'<IsSendable>true</IsSendable>'
        	+'<SendableDataExtensionField>'
		+'    <CustomerKey>Hearsay_User_Reference_ID</CustomerKey>'
		+'    <Name>Hearsay User Reference ID</Name>'
		+'    <FieldType>Text</FieldType>'
		+'</SendableDataExtensionField>'
        	+'<SendableSubscriberField>'
        	...
        	+'</SendableSubscriberField>'
		+'<Fields>'
		+'<CustomerKey>Hearsay_Org_ID</CustomerKey>'
		+'<Name>Hearsay Org ID</Name>'
		+'<FieldType>Text</FieldType>'
		+'<MaxLength>50</MaxLength>'
		+'<IsRequired>true</IsRequired>'
		...
		+'</Field>'
	    	+'<Field>'
		+'<CustomerKey>Customer_Unique_ID</CustomerKey>'
		+'<Name>Customer Unique ID</Name>'
		+'<FieldType>Text</FieldType>'
		+'<MaxLength>50</MaxLength>'
		+'<IsRequired>true</IsRequired>'
		...
		+'</Field>'
	        +'<Field>'
		/*+'<CustomerKey>Created_or_Modified_Date</CustomerKey>'
		+'<Name>Created or Modified Date</Name>'
		+'<FieldType>Date</FieldType>'
	        +'<DefaultValue>getdate()</DefaultValue>'
		+'<IsRequired>true</IsRequired>'
