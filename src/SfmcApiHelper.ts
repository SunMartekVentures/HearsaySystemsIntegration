...
+'                    <Field>'
+'                        <Name>'+template.Template_Name+'</Name>'
+'                        <FieldType>'+template.Template_Name+'</FieldType>'
...
+'                        <FieldType>'+template.Hearsay_User_Reference_ID+'</FieldType>'
+'                        <IsRequired>true</IsRequired>'
+'                    </Field>'
+'                    <Field>'
+'                        <Name>'+template.Customer_Unique_ID+'</Name>'
+'                        <FieldType>'+template.Customer_Unique_ID+'</FieldType>'
+'                        <IsRequired>true</IsRequired>'
+'                    </Field>'
+'                    <Field>'
+'                        <Name>'+template.Customer_Name+'</Name>'
+'                        <FieldType>'+template.Customer_Name+'</FieldType>'
+'                        <IsRequired>true</IsRequired>'
+'                    </Field>'
+'                    <Field>'
+'                        <Name>'+template.Option_1+'</Name>'
+'                        <FieldType>'+template.Option_1+'</FieldType>'
+'                        <IsRequired>false</IsRequired>'
+'                    </Field>'
+'                    <Field>'
+'                        <Name>'+template.Option_2+'</Name>'
+'                        <FieldType>'+template.Option_2+'</FieldType>'
+'                        <IsRequired>false</IsRequired>'
+'                    </Field>'
+'                    <Field>'
+'                        <Name>'+template.Option_3+'</Name>'
+'                        <FieldType>'+template.Option_3+'</FieldType>'
+'                        <IsRequired>false</IsRequired>'
+'                    </Field>'
+'                    <Field>'
+'                        <Name>'+template.Option_4+'</Name>'
+'                        <FieldType>'+template.Option_4+'</FieldType>'
+'                        <IsRequired>false</IsRequired>'
+'                    </Field>'
+'                    <Field>'
+'                        <Name>'+template.Option_5+'</Name>'
+'                        <FieldType>'+template.Option_5+'</FieldType>'
+'                        <IsRequired>false</IsRequired>'
+'                    </Field>'
+'                    <Field>'
+'                        <Name>'+template.Option_6+'</Name>'
+'                        <FieldType>'+template.Option_6+'</FieldType>'
+'                        <IsRequired>false</IsRequired>'
+'                    </Field>'
+'                    <Field>'
+'                        <Name>'+template.Option_7+'</Name>'
+'                        <FieldType>'+template.Option_7+'</FieldType>'
+'                        <IsRequired>false</IsRequired>'
+'                    </Field>'
+'                    <Field>'
+'                        <Name>'+template.Option_8+'</Name>'
+'                        <FieldType>'+template.Option_8+'</FieldType>'
+'                        <IsRequired>false</IsRequired>'
+'                    </Field>'
+'                    <Field>'
